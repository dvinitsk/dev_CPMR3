...
ground_truth = load_data('ground_truth_positions.csv')
stock_model = load_data('stock_model_positions.csv')
updated_model = load_data('updated_model_positions.csv')

# Calculate RMSE for x and y between ground and stock model
rmse_x, rmse_y = calculate_rmse(ground_truth, stock_model)
print(f"Ground Truth vs Stock Model")
print(f"RMSE for x positions: {rmse_x:.3f}")
print(f"RMSE for y positions: {rmse_y:.3f}")
print()
# Calculate RMSE for x and y between ground and updated model
rmse_x, rmse_y = calculate_rmse(ground_truth, updated_model)
print(f"Ground Truth vs Updated Model")
print(f"RMSE for x positions: {rmse_x:.3f}")
print(f"RMSE for y positions: {rmse_y:.3f}")
